...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(avg_vehicles_by_type, x='Vehicle_Type', y='Automobile_Sales', title='Average vehicles sold during recession'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_effect = recession_data.groupby('Vehicle_Type').agg({'Automobile_Sales':'mean', 'Unemployment_Rate': 'mean'}).reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(unemployment_effect, x='Vehicle_Type', y='Automobile_Sales', color='Unemployment_Rate', title='Unemployment effect on vehicle type and sales'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
        figure=px.line(mas, x='Month', y='Automobile_Sales', title="Total monthly car sales {}".format(input_year))
    )
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title="total expenditures on advertising for vehicle share"))
